...
function extract_spikes(X::Array{Float64,1};μ::Float64=NaN, σ::Float64=NaN,nq::Tuple{Int64, Int64}=(20,40),θ=6.0,only_negative=false)
  if isnan(σ) || isnan(μ)
